...
WORKDIR /open-meteo-to-influx-annotated-csv

COPY om_pre_process.py /open-meteo-to-influx-annotated-csv/om_pre_process.py
COPY scripts.py /open-meteo-to-influx-annotated-csv/scripts.py

RUN apt-get update && apt-get -y install cron vim

COPY requirements.txt /open-meteo-to-influx-annotated-csv/requirements.txt
...
CMD cron && python3 om_pre_process.py 22.714183 120.337895 && python3 scripts.py 22.714183 120.337895
